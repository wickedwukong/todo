...
var _user$project$Todo$main = _elm_lang$html$Html$programWithFlags(
	{
		init: _user$project$Todo$init,
		view: _user$project$Todo$view,
		update: _user$project$Todo$update,
...
if (typeof _user$project$Todo$main !== 'undefined') {
    _user$project$Todo$main(Elm['Todo'], 'Todo', {"types":{"unions":{"Todo.Msg":{"args":[],"tags":{"NoOp":[]}}},"aliases":{},"message":"Todo.Msg"},"versions":{"elm":"0.18.0"}});
}
